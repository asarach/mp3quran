...
/***/ "./resources/js/howler-player/mp3player.js":
/*!*************************************************!*\
  !*** ./resources/js/howler-player/mp3player.js ***!
  \*************************************************/
...
var Player = function Player() {
  ...
  var playlist = JSON.parse(localStorage.getItem("mp3quran_playlist2") || "[]");
  this.playerData = JSON.parse(localStorage.getItem("mp3quran_player2") || "{}");
  this.setPlaylist(playlist); //Get old current item
...
Player.prototype = {
  ...
  ************************************/
  ...
  addItemToPlaylist: function addItemToPlaylist(item) {
  ...
  removeItemFromPlaylist: function removeItemFromPlaylist(item) {
    var index = this.getItemIndex(item);
    this.playlist.splice(index, 1);
    this.updatePlaylist();
  },
  swapItemsPlaylist: function swapItemsPlaylist(startIndex, EndIndex) {
  ...
  updatePlaylist: function updatePlaylist() {
    ...
    this.playlist.forEach(function (item) {
      ...
      var fullclone = fullPlaylistItem.content.cloneNode(true); //set text elements
      ...
      fullPlayerList.appendChild(fullclone); //update storage playlist
  ...
  setState: function setState() {
    var self = this;
    var changeStateEvent = new CustomEvent("changeState", {
      'detail': {
  ...
  toggleFullPlayer: function toggleFullPlayer() {
  ...
  skipTo: function skipTo(index) {
    ...
    playerProgressPiont.style.left = 'calc(0% - 6px)'; // Play the new track.
  ...
  ************************************/
  volume: function volume(val) {
    ...
    playerVolumePiont.style.bottom = 'calc(' + val * 100 + 'px - 6px)'; // var barWidth = (val * 90) / 100;
...
/***/ "./resources/js/howler-player/player.js":
/*!**********************************************!*\
  !*** ./resources/js/howler-player/player.js ***!
  \**********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mp3player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mp3player */ "./resources/js/howler-player/mp3player.js");

var elms = ['reciterName', 'playerTimer', 'playerDuration', 'playerPlayBtn', 'playerPauseBtn', 'playerPrevBtn', 'playerNextBtn', 'playerPlaylistBtn', 'playerVolumeBtn', 'playerProgress', 'playerBar', 'playerLoading', 'playerPlaylist', 'playerList', 'playerVolume', 'playerBarFull', 'playerVolume', 'playerVolumeBar', 'playerVolumePiont', 'playlistItem', 'playerProgressBar', 'playerProgressPiont', 'closePlaylist', 'playerProgressLine', 'fullPlayerToggle', 'fullPlayer', 'closeFullplayer', 'fullPlayerNextBtn', 'fullPlayerPrevBtn', 'playerLoading', 'fullPlayerPauseBtn', 'fullPlayerPlayBtn', 'fplyReader', 'fplySora', 'fullPlaylistItem', 'fullPlayerList', 'fullPlayerLoading', 'playerVolumeInner', 'playerVolumePiont', 'playerBackwardBtn', 'playerForwardBtn', 'clearPlaylist', 'savePlaylist', 'playlistName', 'playlistId'];
elms.forEach(function (elm) {
  window[elm] = document.getElementById(elm);
}); // Setup our new audio player class and pass it the playerPlayplayerList.

window.player = new _mp3player__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
if (savePlaylist) {
  savePlaylist.addEventListener('click', function () {
    ...
    for (var index = 0; index < player.playlist.length; index++) {
    ...
    $.post(window.App.urlBase + '/' + window.App.current_language + '/ajax/playlist', data, function (data, textStatus, jqXHR) {
...
playerVolume.addEventListener('mouseup', stopVolumeSlide); // document.body.addEventListener('mouseup', stopSlide);

/***/ }),

/***/ 2:
/*!****************************************************!*\
  !*** multi ./resources/js/howler-player/player.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /opt/homebrew/var/www/mp3quran/resources/js/howler-player/player.js */"./resources/js/howler-player/player.js");
