...
var Player = function Player() {
  ...
  var playlist = JSON.parse(localStorage.getItem("mp3quran_playlist") || "[]");
...
Player.prototype = {
  ...
  ************************************/
  ...
  removeItemToPlaylist: function removeItemToPlaylist(item) {
    var index = this.getItemIndex(item);
