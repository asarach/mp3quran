...
/* harmony import */ var _lib_share__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/share */ "./resources/js/lib/share.js");
/* harmony import */ var _lib_favorites__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/favorites */ "./resources/js/lib/favorites.js");
...
/* harmony import */ var _lib_quran_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/quran-slider */ "./resources/js/lib/quran-slider.js");
/* harmony import */ var _lib_player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./lib/player */ "./resources/js/lib/player.js");
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/utils */ "./resources/js/lib/utils.js");
/* harmony import */ var _lib_playlist__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./lib/playlist */ "./resources/js/lib/playlist.js");
...
window.player = new _lib_player__WEBPACK_IMPORTED_MODULE_6__["default"]();
window.favorites = new _lib_favorites__WEBPACK_IMPORTED_MODULE_3__["default"]();
/************************* */
...
function initiateLib() {
  ...
  $(".ply-btn.btn-play").on("click", function (e) {
    ...
    Object(_lib_utils__WEBPACK_IMPORTED_MODULE_7__["getItemAndPlay"])(url, item, type, time);
  });
  $(".share-btn").on("click", function (e) {
    ...
    window.share = new _lib_share__WEBPACK_IMPORTED_MODULE_2__["default"](params);
    share.showModal();
  });
  ...
  $(".sora-btn.playlist-add").on("click", function (e) {
    var url = $(this).data("url");
    Object(_lib_utils__WEBPACK_IMPORTED_MODULE_7__["addItem"])(url);
  });
...
if ($('#savePlaylist').length) {
  $("#savePlaylist").on("click", function (e) {
    e.preventDefault();
    Object(_lib_playlist__WEBPACK_IMPORTED_MODULE_8__["savePlaylist"])();
  });
}

$(".quran-slider").each(function (e) {
  var control = $(this).data("control");
  new _lib_quran_slider__WEBPACK_IMPORTED_MODULE_5__["default"](this, control);
});
...
/*!***********************************!*\
  !*** ./resources/js/lib/utils.js ***!
  \***********************************/
/*! exports provided: notify, trans, stateChange, getItemAndPlay, addItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
module.exports = __webpack_require__(/*! /opt/homebrew/var/www/mp3quran/resources/js/app_v3.js */"./resources/js/app_v3.js");
