<template>
  ...
  <div class="quick-access">
    <a href="#" :class="inclass" data-toggle="modal" data-target="#quickAccessId">
          ...
          <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group">
                  <select
                    ...
                    v-model="read"
                     @change="getSoar()"
                  >
                    <option value class="d-none" disabled selected>{{trans('text.read')}}</option>
              ...
              <div class="col-md-4 text-center p-1">
                 <button type="button" class="btn btn-secondary" data-dismiss="modal" @click.prevent="getItemAndPlay('/ajax/soar/item?r=' +  read + '&s=' + sora.id )"><play-arrow-icon fillColor="#fff" /></button>
              </div>
            </div>
          </div>
        </div>
