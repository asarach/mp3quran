  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ trans('admin.edit-twenty_rewaya')}}</li>
      </ol>
    </section>
    ...
    <section v-else class="content">
      <div class="row">
        <div class="col-lg-24">
          <twenty_rewaya-form :action="'edit'" :twenty_rewaya="twenty_rewaya"></twenty_rewaya-form>
        </div>
      </div>
...
export default {
  ...
  methods: {
    editRewaya() {
      var self = this;
      axios
        .get(this.ajax_prefix + "twenty_rewaya/edit/" + self.$route.params.id)
        .then(function(response) {
          self.twenty_rewaya = response.data.twenty_rewaya;
    ...
    translatePage() {
      ...
      axios
        .post(
          this.ajax_prefix + "twenty_rewaya/translations/" + self.$route.params.id,
          data
        )
        .then(function(response) {
          self.$notify({
