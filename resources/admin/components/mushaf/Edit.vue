  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ trans('admin.edit-mushaf')}}</li>
      </ol>
    </section>
    ...
    <section v-else class="content">
      <div class="row">
        <div class="col-lg-24">
          <mushaf-form :action="'edit'" :mushaf="mushaf"></mushaf-form>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-24">
...
export default {
  ...
  methods: {
    editMushaf() {
      var self = this;
      axios
        .get(this.ajax_prefix + "mushaf/edit/" + self.$route.params.id)
        .then(function(response) {
          self.mushaf = response.data.mushaf;
    ...
    translatePage() {
      ...
      axios
        .post(
          this.ajax_prefix + "mushaf/translations/" + self.$route.params.id,
          data
        )
        .then(function(response) {
          self.$notify({
