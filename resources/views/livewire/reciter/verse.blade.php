        ...
        <div class="col-lg-19 pt-3" id="sticky-container">
          <div class="sora-item sora-show-item showoptions spib-sora-{{ $sora['id'] }}" id="sora-{{ $sora['id'] }}">
            ...
            <div class="ssi-btns">
              ...
              <div class="ply-btn btn-play shown-ply-btn spib-play" data-url="{{ route('ajax::soar.item') . '?r=' . $sora['read_id'] . '&s=' . $sora['sora_id'] }}" data-item="{{ $sora['id'] }}" data-type="sora" data-time="{{ $sora['start_time'] }}">
